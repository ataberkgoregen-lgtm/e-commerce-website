...
export default function Contact() {
  ...
  return (
    <div className="bg-[url(/background.svg)] bg-cover bg-center min-h-screen text-white ">
      <div className="w-full md:w-3/5 flex flex-row m-auto justify-center items-center min-h-screen flex-wrap py-12 p-10 sm:p-0 gap-10">
        <div className="w-full md:w-1/2 flex flex-col m-auto gap-9 max-w-100">
